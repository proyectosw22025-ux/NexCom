...
import {
  Bell, CheckCheck, CreditCard, ShoppingBag, Loader2, TrendingDown, MessageCircle, RotateCcw, Wallet,
} from "lucide-react";
...
const TIPO_ICONOS: Record<string, typeof Bell> = {
  ...
  NUEVA_DEVOLUCION:   RotateCcw,
  DEVOLUCION_RESUELTA: RotateCcw,
  RETIRO_RESUELTO:    Wallet,
};
